<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="RallyCap.Account.OpenAuthProviders" %>

<div id="socialLoginList">
    <h4>RallyCap Currently only supports facebook authentication.</h4>
    <hr />

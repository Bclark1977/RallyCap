...
function ShowContent(content) {
    ...
    if (content.includes("CountDown")) {
        var item = document.getElementById("GameTime"); if (item != null) item.style.display = "block";
        ...
        $.noty.closeAll();
        var item = document.getElementById("GameTime"); if (item!=null) item.style.display = "none";
        $(".Taunt").each(function () {
